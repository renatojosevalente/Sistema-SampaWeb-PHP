...
try {
    ...
    // Consulta para buscar dados da tabela Resultado_mat com os nomes correspondentes
    ...
    $stmt->bindValue(':idDisciplina', 6, PDO::PARAM_INT); // Filtrando idDisciplina do id=6 ao id=10
    $stmt->execute();
    ...
    if (!empty($resultados)) {
        ...
        echo json_encode(['status' => 'success', 'data' => [], 'message' => 'Nenhum resultado encontrado para a disciplina especificada']);
    }
} catch (Exception $e) {
